...
import ContatoStyles from '../styles/SuporteStyles';
    ...
    <>
      ...
      <View style={ContatoStyles.container}>
        ...
        <View style={ContatoStyles.newTitleContainer}>
          ...
          <Text style={ContatoStyles.pageTitle}>Suporte</Text>
        </View>

        <View style={ContatoStyles.content}>
          <Text style={ContatoStyles.label}>Está com problemas com alguma coisa?
            Envie uma mensagem para a nossa equipe de suporte!</Text>
